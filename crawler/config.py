...
class Settings(BaseSettings):
    ...
    conectaas_token: str = Field(default="", alias="CONECTAAS_TOKEN")
    conectaas_pax: str = Field(default="40", alias="CONECTAAS_PAX")
    conectaas_max_results: str = Field(default="100", alias="CONECTAAS_MAX_RESULTS")
    conectaas_max_number_of_stops: str = Field(default="1", alias="CONECTAAS_MAX_NUMBER_OF_STOPS")
